...
import csd230.lab3.respositories.BookRepository;
import csd230.lab3.respositories.CartItemRepository;
import csd230.lab3.respositories.CartRepository;
	...
	public CommandLineRunner demo(BookRepository repository) {
		return (args) -> {
			...
			for(int i=0;i<5;i++) {
				...
				csd230.lab3.entities.Book book = new csd230.lab3.entities.Book(
						price,
						quantity,
						description,
						title,
			...
			csd230.lab3.entities.Book book = repository.findById(1L);
